package com.currentbp.test.gc.compile.load;
...
public class ClassLoaderTest {
    ...
    名为“com.currentbp.test.gc.compile.load.ClassLoaderTest”的类，并实例化了这个类的对象。 两行输出结
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object obj = myLoader.loadClass("com.currentbp.test.gc.compile.load.ClassLoaderTest").newInstance();
        System.out.println(obj.getClass());
        System.out.println(obj instanceof com.currentbp.test.gc.compile.load.ClassLoaderTest);
    }
}
