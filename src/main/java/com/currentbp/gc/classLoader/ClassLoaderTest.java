package com.currentbp.gc.classLoader;
...
public class ClassLoaderTest {
    ...
    public void customedDefindClassLoader() {
        ...
        try {
            //加载class文件
            Class c = diskLoader.findClass("com.currentbp.gc.classLoader.CommonBean1");
            //===>customedDefindClassLoader: c:class com.currentbp.gc.classLoader.CommonBean1 c.ClassLoader:com.currentbp.gc.classLoader.DiskClassLoader@4ca21d88
            //表示：使用的是自定义的类加载器
